/* ========================================================================================== */
/* FMOD Studio - C++ header file. Copyright (c), Firelight Technologies Pty, Ltd. 2004-2013.  */
/*                                                                                            */
    ...
    */
    ...
    class System
    {
      ...
      public:
        ...
        FMOD_RESULT F_API getDriverInfo           (int id, char *name, short *nameW, int namelen, FMOD_GUID *guid, int *systemrate, FMOD_SPEAKERMODE *speakermode, int *speakermodechannels);
        ...
        FMOD_RESULT F_API attachChannelGroupToPort   (FMOD_PORT_TYPE portType, FMOD_PORT_INDEX portIndex, ChannelGroup *channelgroup);
        ...
        FMOD_RESULT F_API getRecordDriverInfo     (int id, char *name, short *nameW, int namelen, FMOD_GUID *guid, int *systemrate, FMOD_SPEAKERMODE *speakermode, int *speakermodechannels);
    ...
    */
    class ChannelControl
    {
      ...
      public:
        ...
        FMOD_RESULT F_API addDSP                 (int index, DSP *dsp, DSPConnection **dspconnection);
    ...
    */
    class DSP
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setWetDryMix           (float wet, float dry);
        FMOD_RESULT F_API getWetDryMix           (float *wet, float *dry);
