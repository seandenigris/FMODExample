...
FMOD_RESULT F_API FMOD_System_GetDriverInfo          (FMOD_SYSTEM *system, int id, char *name, short *nameW, int namelen, FMOD_GUID *guid, int *systemrate, FMOD_SPEAKERMODE *speakermode, int *speakermodechannels);
...
FMOD_RESULT F_API FMOD_System_AttachChannelGroupToPort(FMOD_SYSTEM *system, FMOD_PORT_TYPE portType, FMOD_PORT_INDEX portIndex, FMOD_CHANNELGROUP *channelgroup);
...
FMOD_RESULT F_API FMOD_System_GetRecordDriverInfo    (FMOD_SYSTEM *system, int id, char *name, short *nameW, int namelen, FMOD_GUID *guid, int *systemrate, FMOD_SPEAKERMODE *speakermode, int *speakermodechannels);
...
FMOD_RESULT F_API FMOD_Channel_AddDSP                (FMOD_CHANNEL *channel, int index, FMOD_DSP *dsp, FMOD_DSPCONNECTION **dspconnection);
...
FMOD_RESULT F_API FMOD_ChannelGroup_GetDSPClock      (FMOD_CHANNELGROUP *channelgroup, unsigned int *dspclock, unsigned int *parentclock);
FMOD_RESULT F_API FMOD_ChannelGroup_SetDelay         (FMOD_CHANNELGROUP *channelgroup, unsigned int dspclock_start, unsigned int dspclock_end, FMOD_BOOL stopchannels);
FMOD_RESULT F_API FMOD_ChannelGroup_GetDelay         (FMOD_CHANNELGROUP *channelgroup, unsigned int *dspclock_start, unsigned int *dspclock_end, FMOD_BOOL *stopchannels);
FMOD_RESULT F_API FMOD_ChannelGroup_AddFadePoint     (FMOD_CHANNELGROUP *channelgroup, unsigned int dspclock, float volume);
FMOD_RESULT F_API FMOD_ChannelGroup_RemoveFadePoints (FMOD_CHANNELGROUP *channelgroup, unsigned int dspclock_start, unsigned int dspclock_end);
FMOD_RESULT F_API FMOD_ChannelGroup_GetFadePoints    (FMOD_CHANNELGROUP *channelgroup, unsigned int *numpoints, unsigned int *point_dspclock, float *point_volume);
...
FMOD_RESULT F_API FMOD_ChannelGroup_AddDSP           (FMOD_CHANNELGROUP *channelgroup, int index, FMOD_DSP *dsp, FMOD_DSPCONNECTION **dspconnection);
...
/*
     DSP functionality specific to channel groups
*/
...
FMOD_RESULT F_API FMOD_DSP_SetWetDryMix              (FMOD_DSP *dsp, float wet, float dry);
FMOD_RESULT F_API FMOD_DSP_GetWetDryMix              (FMOD_DSP *dsp, float *wet, float *dry);
