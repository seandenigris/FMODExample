...
int FMOD_Main()
{
    ...
    */
    ...
    result = system->createSound(Common_MediaPath("drumloop.wav"), FMOD_SOFTWARE | FMOD_2D | FMOD_LOOP_OFF, 0, &sound1);
    ERRCHECK(result);

    result = system->createSound(Common_MediaPath("stereo.ogg"), FMOD_SOFTWARE | FMOD_2D | FMOD_LOOP_OFF,  0, &sound2);
    ERRCHECK(result);
