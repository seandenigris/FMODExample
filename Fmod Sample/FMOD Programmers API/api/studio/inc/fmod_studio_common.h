...
typedef struct
{
    ...
    FMOD_FILE_OPENCALLBACK  openCallback;       /* Callback for opening this file. */
    FMOD_FILE_CLOSECALLBACK closeCallback;      /* Callback for closing this file. */
    FMOD_FILE_READCALLBACK  readCallback;       /* Callback for reading from this file. */
    FMOD_FILE_SEEKCALLBACK  seekCallback;       /* Callback for seeking within this file. */
